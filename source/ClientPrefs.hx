...
class ClientPrefs {
	...
	public static var runmodcharts:Bool = true;
	public static var freeplayzoom:Bool = true;
	public static var healthtype:String = 'Psych';
	public static var defaultfont:String = 'Bronx';
	public static var latedamage:Bool = true;
	public static var runshaders:Bool = true;
	...
	public static function saveSettings() {
		...
		FlxG.save.data.defaultfont = defaultfont;
	...
	public static function loadPrefs() {
		...
		if(FlxG.save.data.defaultfont != null) {
			defaultfont = FlxG.save.data.defaultfont;
		}
